...
static IXBaseEvaluationUtility const kIXCapitalizeFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
    return [stringToModify capitalizedString];
};

static IXBaseEvaluationUtility const kIXCurrencyFunction = ^NSString*(NSString* stringToModify,NSArray* parameters)
{
    ...
    if( [stringToModify length] > 0 )
    {
        ...
        {
            NSString* currencyCode = [[parameters firstObject] getAttributeValue];
...
static IXBaseEvaluationUtility const kIXDistanceFunction = ^NSString*(NSString* unusedStringProperty,NSArray* parameters){
    NSString* returnString = nil;
    if( [parameters count] > 1 )
    {
        NSString* latLong1 = [[parameters firstObject] getAttributeValue];
        NSString* latLong2 = [[parameters lastObject] getAttributeValue];
...
static IXBaseEvaluationUtility const kIXFromBase64Function = ^NSString*(NSString* stringToDecode,NSArray* parameters){
    return [NSString ix_fromBase64String:stringToDecode];
};

static IXBaseEvaluationUtility const kIXIsFunction = ^NSString*(NSString* inputString,NSArray* parameters){
...
static IXBaseEvaluationUtility const kIXLengthFunction = ^NSString*(NSString* stringToEvaluate,NSArray* parameters){
    return [NSString stringWithFormat:@"%lu", (unsigned long)[stringToEvaluate length]];
};

static IXBaseEvaluationUtility const kIXMomentFunction = ^NSString*(NSString* dateToFormat,NSArray* parameters)
{
    if ([parameters count] > 1) {
...
static IXBaseEvaluationUtility const kIXMonogramFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
    return ([parameters firstObject] != nil) ? [NSString ix_monogramString:stringToModify ifLengthIsGreaterThan:[[parameters.firstObject getAttributeValue] intValue]] : [NSString ix_monogramString:stringToModify ifLengthIsGreaterThan:0];
};

static IXBaseEvaluationUtility const kIXNowFunction = ^NSString*(NSString* unusedStringProperty,NSArray* parameters){
...
static IXBaseEvaluationUtility const kIXRandomNumberFunction = ^NSString*(NSString* unusedStringProperty,NSArray* parameters){
    if ([parameters count] > 1) {
        NSUInteger lowerBound = [[[parameters firstObject] getAttributeValue] integerValue];
        NSUInteger upperBound = [[[parameters lastObject] getAttributeValue] integerValue];
        return [NSString stringWithFormat:@"%lu",arc4random_uniform((u_int32_t)upperBound) + lowerBound];
    } else if ([parameters count] == 1) {
        return [NSString stringWithFormat:@"%i",arc4random_uniform((u_int32_t)[[[parameters firstObject] getAttributeValue] integerValue])];
    }
    else {
        return @"0";
    }
...
static IXBaseEvaluationUtility const kIXToBase64Function = ^NSString*(NSString* stringToEncode,NSArray* parameters){
    if (stringToEncode)
...
static IXBaseEvaluationUtility const kIXToHexFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
...
static IXBaseEvaluationUtility const kIXToMD5Function = ^NSString*(NSString* stringToHash,NSArray* parameters){
    if (stringToHash)
...
static IXBaseEvaluationUtility const kIXToLowerCaseFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
    return [stringToModify lowercaseString];
};

static IXBaseEvaluationUtility const kIXToUppercaseFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
    return [stringToModify uppercaseString];
};

static IXBaseEvaluationUtility const kIXToRGBFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
...
static IXBaseEvaluationUtility const kIXURLEncodeFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
    //return [stringToModify uppercaseString];
    return [stringToModify stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
};

static IXBaseEvaluationUtility const kIXURLDecodeFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
    //TODO: URL Decoded;
    return [stringToModify stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
};

static IXBaseEvaluationUtility const kIXTimeFromSecondsFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
...
static IXBaseEvaluationUtility const kIXTruncateFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
    return ([parameters firstObject] != nil) ? [NSString ix_truncateString:stringToModify toIndex:[[[parameters firstObject] getAttributeValue] intValue]] : stringToModify;
};

static IXBaseEvaluationUtility const kIXRadiansToDegreesFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
...
static IXBaseEvaluationUtility const kIXDegreesToRadiansFunction = ^NSString*(NSString* stringToModify,NSArray* parameters){
...
@implementation IXEvaluationUtility
