...
/**
 Convenience method for generating a path against the properties of an object. Takes an `NSString` with property names prefIxd with a colon and interpolates the values of the properties specified and returns the generated path.
 ...
 @param pathPattern An `SOCPattern` string containing zero or more colon-prefIxd property names.
 @param object The object to interpolate the properties against
 @return A new `NSString` object with the values of the given object interpolated for the colon-prefIxd properties name in the given pattern string.
 @see `RKPathMatcher`
 @see `SOCPattern`
 */
