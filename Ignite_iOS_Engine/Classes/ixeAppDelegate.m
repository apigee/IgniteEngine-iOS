...
//    [[self window] setRootViewController:[[ixeAppManager sharedInstance] rootViewController]];
    
    [[ixeAppManager sharedInstance] startApplication];
