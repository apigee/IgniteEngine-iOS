...
@interface  ixeScanner() <ZBarReaderDelegate>

@end

@implementation ixeScanner
...
//    [readerView setCameraOverlayView:[self overlayControl]];
    ...
    [[[ixeAppManager sharedInstance] rootViewController] presentViewController:readerView animated:YES completion:nil];
