...
@interface ixeTextInput () <UITextFieldDelegate>
...
- (void)keyboardWillBeHidden:(NSNotification*)aNotification
{
    ...
    UIViewController* visibleVC = [[[ixeAppManager sharedInstance] rootViewController] visibleViewController];
    if( [visibleVC isKindOfClass:[ixeViewController class]] )
    {
        ixeViewController* ixeVC = (ixeViewController*) visibleVC;
        scrollView = [[ixeVC containerControl] scrollView];
    }
