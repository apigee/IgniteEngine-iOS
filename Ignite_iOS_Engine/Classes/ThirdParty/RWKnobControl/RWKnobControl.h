...
@class RWKnobRenderer;
@class RWRotationGestureRecognizer;

@interface RWKnobControl : UIControl

@property (nonatomic,strong) RWKnobRenderer* knobRenderer;
@property (nonatomic,strong) RWRotationGestureRecognizer* gestureRecognizer;
